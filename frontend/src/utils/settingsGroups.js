export const SETTING_GROUPS = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        type: "slider",
        title: "Camera to plant scan distance",
        description: "The distance between the camera and the plant during scanning. Adjust this value to optimize the scanning range.",
        path: "z_offset",
        min: 0,
        max: 0.3,
        step: 0.05,
